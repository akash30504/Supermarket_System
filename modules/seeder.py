...
CATEGORIES = {
    ...
    "Produce":      ["Banana", "Apple", "Carrot", "Beets", "Avacado", "Tomato",
    ...
    "Frozen":       ["Frozen Pizza", "Ice Cream", "Popsicals", "Fish Fingers",
                     "Frozen Chips", "Frozen Waffles", "Meatballs", "Ice Cornes", "Frozen Lasagna", "Ice Cups"],
